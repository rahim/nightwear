 ...
 */
class HelloDigitalWatchFace : CanvasWatchFaceService() {
    ...
    private class EngineHandler(reference: HelloDigitalWatchFace.Engine) : Handler() {
        private val mWeakReference: WeakReference<HelloDigitalWatchFace.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@HelloDigitalWatchFace)
            ...
            val resources = this@HelloDigitalWatchFace.resources
        ...
        private fun registerReceiver() {
            ...
            this@HelloDigitalWatchFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@HelloDigitalWatchFace.unregisterReceiver(mTimeZoneReceiver)
        }
